...
public class TextUtils {
	...
	public static double getTextWidth(Collection<String> message) {
		...
		for(String line : message) {
			TextMetrics metrics = Main.context.measureText(line);
	...
	public static void growl(Collection<String> msg) {
		...
		int x = (int) (Main.canvasWidth*0.5-TextUtils.getTextWidth(msg));
		int y = (int) (Main.canvasHeight*0.5);
		Point location = new Point(x,y);
		Main.room.addDrawable(new DialogElement(msg, location, 80));
	}	
}
